<template>
  <div v-if="show">
    <el-form label-position="top">
      ...
      <el-form-item label="选项" v-if="data.type != 'table' && Object.keys(data.options).indexOf('options')>=0">
      ...
      <template v-if="data.type == 'table'">
        ...
        <el-form-item label="column列字段信息">
          <draggable tag="ul" :list="data.options.options" 
              ...
              >
                <li v-for="(item, index) in data.options.options" :key="index" >
                  <el-input v-model="item.label" placeholder="列名称" style="width:120px"></el-input>
                  <el-input v-model="item.width" placeholder="列宽度" style="width:120px;margin-left:10px;"></el-input>
                  <el-select v-model="item.propField" placeholder="选择字段" style="width:120px;">
                    <el-option
                      v-for="(field,opindex) in tableField"
                      :key="opindex"
                      :label="field"
                      :value="field">
                    </el-option>
                  </el-select>
                  <el-select v-model="item.propFieldFilterFc" placeholder="过滤方法" style="width:120px;margin-left:10px;">
                    <el-option
                      v-for="(field,opindex) in tableFieldFilterFc"
                      :key="opindex"
                      :label="field"
                      :value="field">
                    </el-option>
          ...
          <div style="margin-left: 22px;">
            <el-button type="text" @click="handleAddTableOption">添加选项</el-button>
          </div>
        </el-form-item>
      </template>
